...
def news():
    ...
    return json.dumps([
        ...
        "活動消息",
        (
            "<div style='text-align:center;'>@市長, 給問嗎xPtt鄉民有約@<br>Ptt邀請了三位台北市長候選人來現場回答鄉民的問題挑戰！<br>這次接力登場的是候選人[連勝文]及[柯文哲], 請大家踴躍發起挑戰吧！<br>9/22 21:00 連勝文 <a href='http://ppt.cc/op8c'>http://ppt.cc/op8c</a><br>9/24 21:00 柯文哲 <a href='http://ppt.cc/JuyC' target='_system'>http://ppt.cc/JuyC</a></div>"
